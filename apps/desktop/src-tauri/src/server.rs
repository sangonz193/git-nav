...
fn exposure(command: &IpcCommand) -> Exposure {
    match command {
        ...
        IpcCommand::watch_repository => Exposure::Api(post(crate::sync::__http_watch_repository)),
        IpcCommand::unwatch_repository => Exposure::Api(post(crate::sync::__http_unwatch_repository)),
        IpcCommand::refresh_repository => Exposure::Api(post(crate::sync::__http_refresh_repository)),
        ...
        IpcCommand::working_tree => Exposure::Api(post(crate::working_tree::__http_working_tree)),
        IpcCommand::working_tree_fingerprint => Exposure::Api(post(crate::working_tree::__http_working_tree_fingerprint)),
        IpcCommand::stage_files => Exposure::Api(post(crate::working_tree::__http_stage_files)),
        IpcCommand::unstage_files => Exposure::Api(post(crate::working_tree::__http_unstage_files)),
        IpcCommand::commit_changes => Exposure::Api(post(crate::working_tree::__http_commit_changes)),
